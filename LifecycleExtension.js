sap.ui.define([
    ...
    return PluginControllerExtension.extend("ritsdmc-az12fc9w.execution.eu20-quality.web.dmc.cloud.sap.customdevplugin.wcPodSelectionExtensionProvider.LifecycleExtension", {
        ...
        onBeforeRendering: function(oEvent){
            if (!this._bInitialized) {
                ...
                let oData = this._oExtensionUtility.getJsonData("ritsdmc-az12fc9w/execution/eu20-quality/web/dmc/cloud/sap/customdevplugin/model/SuppliersModel.json");
        ...
        onAfterRendering: function(oEvent){
            ...
            setTimeout(function() {
                ...
                that._oExtensionUtility.loadShopOrderFilter(that.onCustomOrderFilterPress, that);
            }, 1000);
        },
        ...
        onCustomOrderFilterPress: function (oEvent) {
            let oInputField = oEvent.getSource();
            let sSupplier = oInputField.getValue();
            let oPodSelectionModel = this.getController().getPodSelectionModel();
            if (oPodSelectionModel) {
                if (!oPodSelectionModel.customData) {
                    oPodSelectionModel.customData = {shopOrder: ''};
                }
            }
            oPodSelectionModel.customData.shopOrder = oEvent.mParameters.value;
		}
    })
});
